...
export default function CompetitionHeaderTop({
  ...
  return (
    ...
    //
    // data-comp-hero — крючок для дропдауна селектора: он открывается под hero (то есть под
    // кнопкой «Change»), а не под всей шапкой, и ему нужна именно нижняя граница этого
    // блока. Опираться на структуру шапки селектор не может — она приходит к нему пропом.
    <div data-comp-hero style={{ background: 'var(--theme-primary)', color: 'var(--theme-mode-accent-text)' }}>
