...
export default function FilterZone({
  ...
  return (
    ...
    {/* ЛИПКАЯ на всех ширинах (решение Влада 31.08.2026): переключиться между программой
        ...
        Фон обязателен: панель скруглена, и без подложки сквозь её углы и зазоры
        просвечивал бы уезжающий протокол. Отрицательных полей больше нет — таб живёт в
        своей узкой колонке (`content-box-md`), и подложка ровно её ширины. */}
    <div
      className="sticky z-30 mb-3 pb-2 pt-2"
