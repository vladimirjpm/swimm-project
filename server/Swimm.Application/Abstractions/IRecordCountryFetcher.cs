...
public interface IRecordCountryFetcher
{
    ...
    /// <summary>
    /// Мировые рекорды (WR SCM + LCM) — <b>один раз на прогон</b>, а не на страну: 215 стран
    /// умножили бы эти два файла на 215. Нужны не только ради свежего <c>world</c>: сторож
