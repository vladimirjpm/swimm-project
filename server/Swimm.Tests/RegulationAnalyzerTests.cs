...
public class RegulationAnalyzerTests
{
    ...
    // «ליגה בריכות ארוכות» (loglig 14575): перевёрнутый текст с «מ'» вместо «מטר».
    [InlineData("םוקמ :תורחתה  כירבה  תימואל ןוכמ טייגניו -  50 ,'מ  10  םילולסמ הדוגא", "50m")]
    // Летние отборы 2026 (takanon-3218): скобка унесла «מסלולים» за даты.
    [InlineData("רעי תומדקומה- תכירב( טייגניו50  ,'מ10 :םיאבה םיכיראתה ןיב ,)םילולסמ  םוישישי", "50m")]
