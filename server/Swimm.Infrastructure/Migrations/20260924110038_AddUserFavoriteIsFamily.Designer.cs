...
namespace Swimm.Infrastructure.Migrations
{
    ...
    [Migration("20260924110038_AddUserFavoriteIsFamily")]
    partial class AddUserFavoriteIsFamily
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("HubGroups", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_HubGroups_TestNotOfficial", "NOT (\"IsTest\" AND \"IsOfficial\")");
                        });
                });
            ...
            modelBuilder.Entity("Swimm.Domain.Entities.Record", b =>
                {
                    ...
                    b.Property<int?>("TimeMs")
                        ...
                        .HasColumnType("integer")
                        .HasComputedColumnSql("swim_time_ms(\"Time\")", true);
            ...
            modelBuilder.Entity("Swimm.Domain.Entities.Swimmer", b =>
                {
                    ...
                    b.ToTable("Swimmers", null, t =>
                        {
                            t.HasCheckConstraint("CK_Swimmers_Gender", "\"Gender\" IS NULL OR \"Gender\" IN ('male', 'female')");
                        });
                });
