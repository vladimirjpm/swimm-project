...
- Left block: eyebrow `NAT. RECORD` (9px/800/uppercase/`#9098a4`) + time
  (30px / 800 / tabular-nums / gender `deep`).
- `1px #e9edf3` vertical divider.
- Right block (flex 1, min-width 0): row 1 = gender pill `♂ 10y` + name
  (RTL, 13px/700, ellipsis); row 2 = club (RTL, 11px, `#8a93a3`, ellipsis) +
  date (10px, `#aab0bd`, right).
