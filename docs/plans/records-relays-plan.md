...
- ~~Откуда 25m у «טריילז»~~ — **закрыто 22.09**: умолчание парсера выдавалось за распознанное; бассейн теперь из регламента, новое соревнование без выбора не импортируется (И-30). Открыто: 1566 и 1549/1550 — 25m под вопросом, ждёт Влада.
