...
- **Следующее:** хвосты §5 (`none` у эстафет закрыт 22.09, И-32); `M`/`F` в карточках закрыт 22.09; 25m у טריילז закрыт 22.09 (И-30); следующий — строка эстафетного рекорда на странице пловца.
...
- ~~Откуда 25m у «טריילז»~~ — **закрыто 22.09**: умолчание парсера выдавалось за распознанное; бассейн теперь из регламента, новое соревнование без выбора не импортируется (И-30). 1566 → 50m по регламенту; открыто: 1549/1550 — 25m под вопросом, ждёт Влада.
