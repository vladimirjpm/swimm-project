...
- ◐ 11.2.1. **API.** `Records.TimeMs` сделан 2026-09-16 — ВЫЧИСЛЯЕМАЯ колонка
  ...
  живых значениях. Осталось само API рейтинга: `/api/records` **требует** `region` (400 без него) — для рейтинга
