...
- ⏳ 3.6. (план 11.09.2026; **К1–К3 сделаны** — метки ставятся сами, склейка промахов, правила Redis тестом; сброс пока общий) **Сброс кэша по меткам + готовность к Redis** — вместо
