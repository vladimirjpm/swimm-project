...
- ⏳ 3.6. (план 11.09.2026; **К1–К4 сделаны и в master** — метки ставятся сами, склейка промахов, правила Redis тестом, сброс по меткам сам после коммита (14.09); дальше К5 guard-тест и К6 Redis) **Сброс кэша по меткам + готовность к Redis** — вместо
