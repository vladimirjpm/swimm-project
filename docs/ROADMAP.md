...
- ◐ 11.1.4. **Админка.** На вкладке «Рекорды» экрана Import — выбор стран (все / список /
  ...
  **Сделано 2026-09-16:** блок «Рекорды» на дашборде свёрнут — мир и Израиль отдельными
  карточками, остальные страны одной сводной «Другие страны · стран: N» (иначе после заливки
  там было бы 235 карточек). Сама вкладка — впереди; API прогона готов (11.1.2).
...
- ✅ 11.1.6. **Мастерские мировые рекорды** (2026-09-16, вне исходного плана фазы). Источник
  ...
  **Заливки (Apply) ещё не было** — в базе `world/masters` пусто.
