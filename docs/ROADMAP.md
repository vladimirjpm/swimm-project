...
- ⏳ 3.6. (план 11.09.2026; **К1–К4 сделаны** — метки ставятся сами, склейка промахов, правила Redis тестом, сброс по меткам сам после коммита (14.09); дальше К5 guard-тест и К6 Redis) **Сброс кэша по меткам + готовность к Redis** — вместо
  ...
  строки — решено делать (14.09.2026); К4б.0–К4б.2 сделаны (лишние зависимости страницы группы,
  журнал сбросов на /Admin/Cache — PR #29 поверх PR #28 с К4; метки строк при записи — ветка
  `cache-k4b-02` поверх #29), дальше К4б.3 (сужение при чтении) —
