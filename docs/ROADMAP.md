...
- ⬜ 8.12. Лимит избранного: 30 пловцов и 3 клуба (настройки `FavoritesMaxSwimmers` /
  `FavoritesMaxClubs`), сердечко на пределе неактивно с подсказкой, кнопка «Follow club» в шапке
  клуба. План — `docs/plans/hubgroup-club-subscription-plan.md` П1.
