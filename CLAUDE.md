...
- [`docs/tasks/README.md`](docs/tasks/README.md) — **архив заданий** (59 файлов, часть —
  делегатам, `*-sonnet.md`). Ценны разобранными развилками и контрактами, но разделы
  «что уже готово / не сделано» в них — снимок дня постановки. ⚠ Статус берётся ТОЛЬКО из
  ROADMAP и `docs/plans/`, никогда из задания.
